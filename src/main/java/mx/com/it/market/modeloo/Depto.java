...
@NamedQueries({
    ...
    @NamedQuery(name = "Depto.findByNumDepto", query = "SELECT d FROM Depto d WHERE d.numDepto = :numDepto"),
    @NamedQuery(name = "Depto.findByDepartamento", query = "SELECT d FROM Depto d WHERE d.departamento = :departamento")})
